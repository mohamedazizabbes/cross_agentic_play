...
from models import DebateTurn, DebateLog
    ...
    def run_debate((self)) -> DebateLog:
        ...
        for r in range(1, self.rebuttal_rounds + 1):
            ...
            prompt_a_reb = (
                ...
                f"\"{last_turn_b}\"\n\n"
                "Refute their specific claims point-by-point. Do not restate your opening."
            )
        ...
        self.turns.append(turn_a_close)
        ...
        self.turns.append(turn_b_close)
